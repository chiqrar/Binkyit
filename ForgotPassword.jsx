...
<section className='  w-full  container mx-auto px-2  '>
    ...
    <Link to={"/forgot-password"} className='block ml-auto hover:text-primary-200'>Forgot Password?</Link>
        ...
        <button disabled={!vlaidValue} className={ ` ${vlaidValue? "bg-green-800  hover:bg-green-700" : "bg-gray-500"}
         py-2 text-white rounded font-semibold  my-3 tracking-wide`}>Send Otp</button>

        </form>
        <p>Already have account? <Link className='font-semibold text-green-700 hover:text-green-800 ' 
